...
class ConversationManager:
    ...
    def get_summary(self) -> Dict:
        ...
        message_count = sum(1 for m in self.messages)
        has_system_prompt = sum(1 for m in self.messages if m.role == "system")
    ...
    def export_conversation(self, filepath: str = None) -> List[Dict]:
        ...
        """
        # List for messages (list of dicts)
        data = [{"role": msg.role, "content": msg.content, "timestamp": msg.timestamp} for msg in self.messages]
