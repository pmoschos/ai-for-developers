...
### Πείραμα 1: System Prompts (Personalities):
Το ίδιο ερώτημα οδήγησε σε τελείως διαφορετικές απαντήσεις ανάλογα με το personality και το system prompt που είχε το καθένα.

Παρατηρήθηκαν διαφορές:
- στο ύφος (π.χ. σαρκαστικό, ήρεμο, πειρατής, αυστηρό)
- στο λεξιλόγιο
- στις μεταφορές
- στη δομή της απάντησης

Συμπεραίνουμε ότι το system prompt καθορίζει τη "συμπεριφορά" του μοντέλου και το αποτέλεσμα, ακόμα και με την εισαγωγή ίδιου user prompt.

---

### Πείραμα 2: Temperature:**
- **Temperature = 0.0 (Deterministic)**: Οι απαντήσεις είναι σχεδόν ίδιες και αρκετά προβλέψιμες.
- **Temperature = 0.5 (Balanced)**: Εμφανίζονται μικρές διαφοροποιήσεις και πιο δημιουργικές διατυπώσεις.
- **Temperature = 1.0 (Creative)**: Οι απαντήσεις διαφέρουν σημαντικά μεταξύ τους και είναι πιο δημιουργικές.

Στο πείραμα παρατηρήθηκε ότι ήδη από temperature = 0.5 υπήρχαν εμφανείς διαφορές, ενώ στο 1.0 η ποικιλία ήταν πολύ μεγαλύτερη.

---

### Γενικό συμπέρασμασμα:
Το system prompt καθορίζει *πώς* θα απαντήσει το μοντέλο (ύφος, ρόλος, προσωπικότητα),
ενώ η temperature καθορίζει *πόσο διαφορετικές ή προβλέψιμες* θα είναι οι απαντήσεις.

Παρατηρείται ότι ακόμη και με την ίδια temperature, διαφορετικά system prompts οδηγούν σε διαφορετικά αποτελέσματα, γεγονός που δείχνει ότι το system prompt έχει πρωτεύον ρόλο στον καθορισμό της συμπεριφοράς του μοντέλου.
---
