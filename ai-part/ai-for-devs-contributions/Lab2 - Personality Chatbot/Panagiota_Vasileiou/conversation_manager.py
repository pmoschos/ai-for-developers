...
class ConversationManager:
    ...
    def get_messages(self) -> List[Dict[str, str]]:
        ...
        for ms in self.messages:
            result.append({"role": ms.role, "content": ms.content})
    ...
    def get_summary(self) -> Dict:
        ...
        user_messages = sum(1 for mess in self.messages if mess.role == "user")
        assistant_messages = sum(1 for mess in self.messages if mess.role == "assistant")
