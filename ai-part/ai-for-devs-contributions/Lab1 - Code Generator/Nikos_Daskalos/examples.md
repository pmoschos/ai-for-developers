...
```bash
python3 code_generator.py "a function that calculates the factorial of a number"
```

### Generate with unit tests

```bash
python3 code_generator.py "a function that reverses a string" --with-tests
```

### Save to file

```bash
python3 code_generator.py "binary search in a sorted list" --save binary_search.py
```

### Combine options

```bash
python3 code_generator.py "merge sort algorithm" --with-tests --save merge_sort.py
```

### Interactive mode

```bash
python3 code_generator.py -i
```
